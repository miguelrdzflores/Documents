...
!          -object_files {difusion2.o GlobalData.o Data_in_out2.o solver.o}\
...
!       Lee los parametros del archivo param.in
        ...
        CALL input_data (delta_x,x_min,x_max,delta_t,kappa,bound_right,nx,timestep)
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!       OPALM       
...
!       Resuelve la matriz
        ...
        WRITE (PL_OUT,*)"Los resultados se encuentran el archivo resultados_barra2.out"        
