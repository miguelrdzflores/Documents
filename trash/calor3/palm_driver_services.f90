...
!                               date: Tue Nov  8 16:49:58 CST 2016 
...
!
   select case (id_linesw) 
     ...
     case (3)
        call PALM_Step(0, 1,1:10,PL_NO_TAG,1,il_ppalm_err)
        if_ppalm_b0_ctrlstruc = 0
        return
...
!
   select case (id_linesw) 
     ...
     case (4)
        call PALM_Step(1, 1,PL_NO_TIME,PL_NO_TAG,1,il_ppalm_err)
...
!
   select case (id_unit) 
          case (1)
!              main_calor1d
               call getenv('NBPROC_main_calor1d',cl_nbproc)
...
!
   select case (id_unit) 
          case (3)
!              main_imprime_2
               call getenv('NBPROC_main_imprime_2',cl_nbproc)
               if (cl_nbproc(1:3) .eq. '   ') then 
                   id_value = 1
!                   print *, '====> nb_proc affecte par defaul par prepalm a : ',id_value
               else
