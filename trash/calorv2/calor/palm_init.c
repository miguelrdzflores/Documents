...
/* file created by prepalm_mp user miguel Wed Oct 12 17:03:49 CDT 2016 */
...
char *cf_ppalm_os(char *cla_uname, char *cla_oname)
{
   if (strcmp(cla_uname, "BUFFER" ) == 0 )  {
      if (strcmp(cla_oname, "matriz" ) == 0 )  return("NULL");
   }
   ...
   if (strcmp(cla_uname, "vecteur_print" ) == 0 )  {
      if (strcmp(cla_oname, "vecteur.vecteur_print" ) == 0 )  return("mat1d.calor1d");
   }
   return NULL;
}
...
{
   static char *cl_name[] = {"palm_main","main_calor1d","main_vecteur_print"};
   return cl_name;
}
...
{
   static char *cl_name[] = {"calor1d","vecteur_print"};
   return cl_name;
}
...
int if_ppalm_exenum_for_entname(char *cd_entname)
{
   ...
   /* vecteur_print ---> 1 ---> 1 */
   if (strcmp("vecteur_print",cd_entname) == 0) return 1;
