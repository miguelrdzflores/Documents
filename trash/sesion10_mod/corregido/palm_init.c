...
/* file created by prepalm_mp user miguel Tue Oct 25 13:33:00 CDT 2016 */
 
/* return the .pil filename */
char *cf_prepalm_name()
{
    return("session_10.pil");
}
...
char *cf_ppalm_os(char *cla_uname, char *cla_oname)
{
   if (strcmp(cla_uname, "BUFFER" ) == 0 )  {
      if (strcmp(cla_oname, "somme" ) == 0 )  return("one_integer");
      if (strcmp(cla_oname, "moyenne" ) == 0 )  return("one_integer");
   }
   if (strcmp(cla_uname, "Block_1" ) == 0 )  {
      if (strcmp(cla_oname, "b1_get_1.Block_1" ) == 0 )  return("one_integer");
      if (strcmp(cla_oname, "b1_put_1.Block_1" ) == 0 )  return("one_integer");
   }
   if (strcmp(cla_uname, "b2" ) == 0 )  {
      if (strcmp(cla_oname, "b2_get_1.b2" ) == 0 )  return("one_integer");
      if (strcmp(cla_oname, "b2_put_1.b2" ) == 0 )  return("one_integer");
   }
   if (strcmp(cla_uname, "je_compte" ) == 0 )  {
      if (strcmp(cla_oname, "i.je_compte" ) == 0 )  return("one_integer");
      if (strcmp(cla_oname, "n.je_compte" ) == 0 )  return("one_integer");
      if (strcmp(cla_oname, "somme.je_compte" ) == 0 )  return("one_integer");
   }
   return NULL;
}
  ...
  switch (il_num)
    {
     case 0:
         /* main_block_1 */
          cl_nbproc = getenv("NBPROC_main_block_1");
          if (cl_nbproc == NULL) {
               return 1;
          } else {
...
{
   static char *cl_name[] = {"palm_main","main_block_1"};
   return cl_name;
}
...
int if_ppalm_exenum_for_entname(char *cd_entname)
{
   ...
   /* Block_1 ---> 0 ---> 0 */
   if (strcmp("Block_1",cd_entname) == 0) return 0;
   ...
   /* je_compte ---> Block_1 ---> 0 */
   if (strcmp("je_compte",cd_entname) == 0) return 0;
...
int if_ppalm_branch_for_entname(char *cd_entname)
{
   ...
   /* je_compte ---> 0 */
   if (strcmp("main_je_compte",cd_entname) == 0) return 0;
   if (strcmp("main_block_1",cd_entname) == 0) return 0;
