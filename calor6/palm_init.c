...
/* file created by prepalm_mp user miguel Sat Nov 12 10:18:29 CST 2016 */
...
{
   static char *cl_name[] = {"condiciones","solver"};
   return cl_name;
}
...
int if_ppalm_exenum_for_entname(char *cd_entname)
{
   ...
   /* condiciones ---> Block_1 ---> 0 */
   if (strcmp("condiciones",cd_entname) == 0) return 0;
 
   /* solver ---> Block_1 ---> 0 */
   if (strcmp("solver",cd_entname) == 0) return 0;
