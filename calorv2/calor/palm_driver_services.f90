...
!                               date: Wed Oct 12 17:03:49 CDT 2016 
...
!  
   ...
   if(id_z_in.ge.1.and.id_z_in.le.6) then
       id_z_nb = id_z_nb+1
       if (id_z_nb.le.id_z_list_size) ida_z_list(id_z_nb) = id_z_cpt + id_z_in - 1 + 1 
   endif 
   id_z_nbtot = 6 - 1 + 1
...
!  return the element'th in expression 1:6 
...
if_ppalm_ppsexp_givetime_0_1 = 1 + id_z_in - 1
