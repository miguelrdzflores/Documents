...
!******DECLARACIONES Y CONSTANTES DE OPALM**************************************
        ...
        DOUBLE PRECISION :: X(IP_SIZE),U(IP_SIZE),delta_t,t_min,lambda,t_ref
...
!******************esquema de Euler**************************************
        DO i=1,3
         t_ref= time + delta_t*(i)/4.0
         WRITE (6,'(a)')''
         WRITE (6,'(a)')''
         WRITE (PL_OUT,'(a)')'Refinamiento'
         WRITE(6,'(a,e12.5)')"Tiempo=  ", t_ref
         WRITE(PL_OUT,'(a,e12.5)')"#Tiempo=  ", t_ref
         ...
         DO K=1,N+2
                ...
                WRITE(8,'(e12.5,5X,e12.5)')X(k),U(k)
         ENDDO
         CLOSE(8)
         WRITE (PL_OUT,'(a)')''
         WRITE (6,'(a)')''
