...
/* file created by prepalm_mp user miguel Fri Aug  5 13:30:28 CDT 2016 */
...
char *cf_ppalm_os(char *cla_uname, char *cla_oname)
{
   ...
   if (strcmp(cla_uname, "difusion2" ) == 0 )  {
      if (strcmp(cla_oname, "matriz.difusion2" ) == 0 )  return("mat1d.difusion2");
   }
   return NULL;
}
  ...
  switch (il_num)
    {
     case 0:
         /* main_difusion2 */
          cl_nbproc = getenv("NBPROC_main_difusion2");
          if (cl_nbproc == NULL) {
               return 1;
          } else {
...
{
   static char *cl_name[] = {"palm_main","main_difusion2","main_calor1d"};
   return cl_name;
}
...
{
   static char *cl_name[] = {"difusion2","calor1d"};
   return cl_name;
}
...
int if_ppalm_exenum_for_entname(char *cd_entname)
{
   ...
   /* difusion2 ---> 0 ---> 0 */
   if (strcmp("difusion2",cd_entname) == 0) return 0;
 
   /* calor1d ---> 1 ---> 1 */
   if (strcmp("calor1d",cd_entname) == 0) return 1;
...
int if_ppalm_branch_for_entname(char *cd_entname)
{
   ...
   /* difusion2 ---> 1 */
   if (strcmp("main_difusion2",cd_entname) == 0) return 1;
   /* calor1d ---> 0 */
