...
/* file created by prepalm_mp user miguel Thu Jul 21 16:53:41 CDT 2016 */
 
/* return the .pil filename */
char *cf_prepalm_name()
{
    return("barra_completa.pil");
}
...
{
   static char *cl_name[] = {"palm_main","main_difusion","main_difusion2"};
   return cl_name;
}
...
{
   static char *cl_name[] = {"difusion","difusion2"};
   return cl_name;
}
...
int if_ppalm_exenum_for_entname(char *cd_entname)
{
   ...
   /* barra_1 ---> 0 ---> 0 */
   if (strcmp("barra_1",cd_entname) == 0) return 0;
 
   /* barra_2 ---> 0 ---> 0 */
   if (strcmp("barra_2",cd_entname) == 0) return 0;
 
   /* difusion ---> 0 ---> 0 */
   if (strcmp("difusion",cd_entname) == 0) return 0;
 
   /* difusion2 ---> 1 ---> 1 */
   if (strcmp("difusion2",cd_entname) == 0) return 1;
