...
/* file created by prepalm_mp user miguel Thu Aug  4 09:55:33 CDT 2016 */
...
char *cf_ppalm_os(char *cla_uname, char *cla_oname)
{
   if (strcmp(cla_uname, "BUFFER" ) == 0 )  {
      if (strcmp(cla_oname, "matriz" ) == 0 )  return("mat1d.calor1d");
   }
   if (strcmp(cla_uname, "calor1d" ) == 0 )  {
      if (strcmp(cla_oname, "matriz.calor1d" ) == 0 )  return("mat1d.calor1d");
   }
   if (strcmp(cla_uname, "calor1d_2" ) == 0 )  {
      if (strcmp(cla_oname, "matriz.calor1d_2" ) == 0 )  return("mat1d.calor1d_2");
   }
   return NULL;
}
  ...
  switch (il_num)
    {
     ...
     case 1:
         /* main_calor1d_2 */
          cl_nbproc = getenv("NBPROC_main_calor1d_2");
          if (cl_nbproc == NULL) {
               return 1;
          } else {
               return atoi(cl_nbproc);
...
{
   static char *cl_name[] = {"palm_main","main_calor1d","main_calor1d_2"};
   return cl_name;
}
...
{
   static char *cl_name[] = {"calor1d","calor1d_2"};
   return cl_name;
}
...
int if_ppalm_exenum_for_entname(char *cd_entname)
{
   ...
   /* barra1 ---> 0 ---> 0 */
   if (strcmp("barra1",cd_entname) == 0) return 0;
 
   /* barra2 ---> 0 ---> 0 */
   if (strcmp("barra2",cd_entname) == 0) return 0;
 
   /* calor1d ---> 0 ---> 0 */
   if (strcmp("calor1d",cd_entname) == 0) return 0;
 
   /* calor1d_2 ---> 1 ---> 1 */
   if (strcmp("calor1d_2",cd_entname) == 0) return 1;
...
int if_ppalm_branch_for_entname(char *cd_entname)
{
   ...
   /* calor1d_2 ---> 1 */
   if (strcmp("main_calor1d_2",cd_entname) == 0) return 1;
